...
// mixed obj
const names: string[] = ["khan", "kazi", "hawlader", "dafadar"];
const age: number[] = [23, 32, 10, 34];
names.push("mollah");
console.log(names);
...
const fruites: (
  ...
  | {}
)[] = ["mango", 34, "apple", { name: "fruites" }, true, "grapes"];
fruites.push("local");
...
const mixedThings: (string | number | boolean | {})[] = [
  200,
  "one",
  () => "hello",
  {},
...
const mixedArr: (string | number | boolean | object | Function)[] = [
  200,
  "one",
  [2, 3, 4],
  () => "hello",
